<template>
  <div class="flex font-sans">
    ...
    <div class="ml-20 text-lg my-auto">
      ...
      <h3 class="pb-4 font-semibold">👪 Que pouvons nous t'apporter ?</h3>
      <ul class="list-disc">
        <li class="ml-5">Un groupe soudé et motivé pour monter 60</li>
        <li class="ml-5">Du PvP Outdoor en dehors des heures de raid</li>
        <li class="ml-5">Un clean complet du PvE HL (sans viser les serveurs firsts)</li>
        <li class="ml-5">Une communauté avec qui jouer à d’autres jeux (LoL, Overwatch, etc.) en attendant la release</li>
        <li class="ml-5">purple l00tz?</li>
      </ul>
    </div>
  </div>
</template>
